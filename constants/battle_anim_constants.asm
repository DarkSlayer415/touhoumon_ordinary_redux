...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_SHOOTING_SPARKLE    ; ab
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	const_def
	const BATTLE_ANIM_FRAMESET_00 ; BATTLE_ANIM_FRAMESET_HIT_BIG
	const BATTLE_ANIM_FRAMESET_01 ; BATTLE_ANIM_FRAMESET_HIT
	const BATTLE_ANIM_FRAMESET_02 ; BATTLE_ANIM_FRAMESET_HIT_SMALL
	const BATTLE_ANIM_FRAMESET_03 ; BATTLE_ANIM_FRAMESET_PUNCH
	const BATTLE_ANIM_FRAMESET_04 ; BATTLE_ANIM_FRAMESET_KICK
	const BATTLE_ANIM_FRAMESET_05 ; BATTLE_ANIM_FRAMESET_PALM
	const BATTLE_ANIM_FRAMESET_06 ; BATTLE_ANIM_FRAMESET_FANG
	const BATTLE_ANIM_FRAMESET_07 ; BATTLE_ANIM_FRAMESET_PUNCH_SHAKE
	const BATTLE_ANIM_FRAMESET_08 ; BATTLE_ANIM_FRAMESET_BALL_POOF
	const BATTLE_ANIM_FRAMESET_09 ; BATTLE_ANIM_FRAMESET_POKE_BALL_1
	const BATTLE_ANIM_FRAMESET_0A ; BATTLE_ANIM_FRAMESET_POKE_BALL_2
	const BATTLE_ANIM_FRAMESET_0B ; BATTLE_ANIM_FRAMESET_POKE_BALL_3
	const BATTLE_ANIM_FRAMESET_0C ; BATTLE_ANIM_FRAMESET_POKE_BALL_4
	const BATTLE_ANIM_FRAMESET_0D ; BATTLE_ANIM_FRAMESET_POKE_BALL_5
	const BATTLE_ANIM_FRAMESET_0E ; BATTLE_ANIM_FRAMESET_DRAGON_RAGE
	const BATTLE_ANIM_FRAMESET_0F ; BATTLE_ANIM_FRAMESET_FLAMETHROWER
	const BATTLE_ANIM_FRAMESET_10 ; BATTLE_ANIM_FRAMESET_EMBER
	const BATTLE_ANIM_FRAMESET_11 ; BATTLE_ANIM_FRAMESET_BURNED
	const BATTLE_ANIM_FRAMESET_12 ; BATTLE_ANIM_FRAMESET_BLIZZARD
	const BATTLE_ANIM_FRAMESET_13 ; BATTLE_ANIM_FRAMESET_ICE
	const BATTLE_ANIM_FRAMESET_14 ; BATTLE_ANIM_FRAMESET_ICE_BEAM
	const BATTLE_ANIM_FRAMESET_15 ; BATTLE_ANIM_FRAMESET_POWDER_SNOW
	const BATTLE_ANIM_FRAMESET_16 ; BATTLE_ANIM_FRAMESET_RAZOR_LEAF_1
	const BATTLE_ANIM_FRAMESET_17 ; BATTLE_ANIM_FRAMESET_RAZOR_LEAF_2
	const BATTLE_ANIM_FRAMESET_18 ; BATTLE_ANIM_FRAMESET_EXPLOSION
	const BATTLE_ANIM_FRAMESET_19 ; BATTLE_ANIM_FRAMESET_BIG_ROCK
	const BATTLE_ANIM_FRAMESET_1A ; BATTLE_ANIM_FRAMESET_SMALL_ROCK
	const BATTLE_ANIM_FRAMESET_1B ; BATTLE_ANIM_FRAMESET_STRENGTH
	const BATTLE_ANIM_FRAMESET_1C ; BATTLE_ANIM_FRAMESET_SKULL_CROSSBONE
	const BATTLE_ANIM_FRAMESET_1D ; BATTLE_ANIM_FRAMESET_ACID
	const BATTLE_ANIM_FRAMESET_1E ; BATTLE_ANIM_FRAMESET_POISON_DROPLET_UNUSED
	const BATTLE_ANIM_FRAMESET_1F ; BATTLE_ANIM_FRAMESET_SLUDGE_BUBBLE
	const BATTLE_ANIM_FRAMESET_20 ; BATTLE_ANIM_FRAMESET_SLUDGE_BUBBLE_BURST
	const BATTLE_ANIM_FRAMESET_21 ; BATTLE_ANIM_FRAMESET_SMALL_BUBBLE
	const BATTLE_ANIM_FRAMESET_22 ; BATTLE_ANIM_FRAMESET_PULSING_BUBBLE
	const BATTLE_ANIM_FRAMESET_23 ; BATTLE_ANIM_FRAMESET_SURF
	const BATTLE_ANIM_FRAMESET_24 ; BATTLE_ANIM_FRAMESET_MUSIC_NOTE_1
	const BATTLE_ANIM_FRAMESET_25 ; BATTLE_ANIM_FRAMESET_MUSIC_NOTE_2
	const BATTLE_ANIM_FRAMESET_26 ; BATTLE_ANIM_FRAMESET_MUSIC_NOTE_3
	const BATTLE_ANIM_FRAMESET_27 ; BATTLE_ANIM_FRAMESET_WATER_GUN_1
	const BATTLE_ANIM_FRAMESET_28 ; BATTLE_ANIM_FRAMESET_WATER_GUN_2
	const BATTLE_ANIM_FRAMESET_29 ; BATTLE_ANIM_FRAMESET_WATER_GUN_3
	const BATTLE_ANIM_FRAMESET_2A ; BATTLE_ANIM_FRAMESET_HYDRO_PUMP
	const BATTLE_ANIM_FRAMESET_2B ; BATTLE_ANIM_FRAMESET_POWDER
	const BATTLE_ANIM_FRAMESET_2C ; BATTLE_ANIM_FRAMESET_BEAM
	const BATTLE_ANIM_FRAMESET_2D ; BATTLE_ANIM_FRAMESET_BEAM_TIP
	const BATTLE_ANIM_FRAMESET_2E ; BATTLE_ANIM_FRAMESET_ICE_BUILDUP
	const BATTLE_ANIM_FRAMESET_2F ; BATTLE_ANIM_FRAMESET_FROZEN
	const BATTLE_ANIM_FRAMESET_30 ; BATTLE_ANIM_FRAMESET_CIRCLING_SPARKLE
	const BATTLE_ANIM_FRAMESET_31 ; BATTLE_ANIM_FRAMESET_THUNDER_CENTER
	const BATTLE_ANIM_FRAMESET_32 ; BATTLE_ANIM_FRAMESET_THUNDER_LEFT
	const BATTLE_ANIM_FRAMESET_33 ; BATTLE_ANIM_FRAMESET_THUNDER_RIGHT
	const BATTLE_ANIM_FRAMESET_34 ; BATTLE_ANIM_FRAMESET_THUNDER_WAVE_DISABLE
	const BATTLE_ANIM_FRAMESET_35 ; BATTLE_ANIM_FRAMESET_THUNDER_WAVE_EXTRA
	const BATTLE_ANIM_FRAMESET_36 ; BATTLE_ANIM_FRAMESET_THUNDERBOLT_SPARKS
	const BATTLE_ANIM_FRAMESET_37 ; BATTLE_ANIM_FRAMESET_THUNDERBOLT_CORE
	const BATTLE_ANIM_FRAMESET_38 ; BATTLE_ANIM_FRAMESET_THUNDERSHOCK_SPARKS
	const BATTLE_ANIM_FRAMESET_39 ; BATTLE_ANIM_FRAMESET_THUNDERSHOCK_CORE
	const BATTLE_ANIM_FRAMESET_3A ; BATTLE_ANIM_FRAMESET_BITE_1
	const BATTLE_ANIM_FRAMESET_3B ; BATTLE_ANIM_FRAMESET_BITE_2
	const BATTLE_ANIM_FRAMESET_3C ; BATTLE_ANIM_FRAMESET_CUT_DOWN_LEFT
	const BATTLE_ANIM_FRAMESET_3D ; BATTLE_ANIM_FRAMESET_CUT_DOWN_RIGHT
	const BATTLE_ANIM_FRAMESET_3E ; BATTLE_ANIM_FRAMESET_CUT_UP_RIGHT
	const BATTLE_ANIM_FRAMESET_3F ; BATTLE_ANIM_FRAMESET_CUT_LONG_DOWN_LEFT
	const BATTLE_ANIM_FRAMESET_40 ; BATTLE_ANIM_FRAMESET_CUT_LONG_DOWN_RIGHT
	const BATTLE_ANIM_FRAMESET_41 ; BATTLE_ANIM_FRAMESET_CHARGE_ORB_1
	const BATTLE_ANIM_FRAMESET_42 ; BATTLE_ANIM_FRAMESET_ABSORB_CENTER
	const BATTLE_ANIM_FRAMESET_43 ; BATTLE_ANIM_FRAMESET_GUST
	const BATTLE_ANIM_FRAMESET_44 ; BATTLE_ANIM_FRAMESET_VINE_WHIP_1
	const BATTLE_ANIM_FRAMESET_45 ; BATTLE_ANIM_FRAMESET_VINE_WHIP_2
	const BATTLE_ANIM_FRAMESET_46 ; BATTLE_ANIM_FRAMESET_RAZOR_WIND_1
	const BATTLE_ANIM_FRAMESET_47 ; BATTLE_ANIM_FRAMESET_RAZOR_WIND_2
	const BATTLE_ANIM_FRAMESET_48 ; BATTLE_ANIM_FRAMESET_SONICBOOM_JP
	const BATTLE_ANIM_FRAMESET_49 ; BATTLE_ANIM_FRAMESET_WARP
	const BATTLE_ANIM_FRAMESET_4A ; BATTLE_ANIM_FRAMESET_CHARGE_ORB_2
	const BATTLE_ANIM_FRAMESET_4B ; BATTLE_ANIM_FRAMESET_EGG
	const BATTLE_ANIM_FRAMESET_4C ; BATTLE_ANIM_FRAMESET_EGG_WOBBLE
	const BATTLE_ANIM_FRAMESET_4D ; BATTLE_ANIM_FRAMESET_EGG_CRACKED_TOP
	const BATTLE_ANIM_FRAMESET_4E ; BATTLE_ANIM_FRAMESET_EGG_CRACKED_BOTTOM
	const BATTLE_ANIM_FRAMESET_4F ; BATTLE_ANIM_FRAMESET_FOCUS
	const BATTLE_ANIM_FRAMESET_50 ; BATTLE_ANIM_FRAMESET_BIND_1
	const BATTLE_ANIM_FRAMESET_51 ; BATTLE_ANIM_FRAMESET_BIND_2
	const BATTLE_ANIM_FRAMESET_52 ; BATTLE_ANIM_FRAMESET_BIND_3
	const BATTLE_ANIM_FRAMESET_53 ; BATTLE_ANIM_FRAMESET_BIND_4
	const BATTLE_ANIM_FRAMESET_54 ; BATTLE_ANIM_FRAMESET_LEECH_SEED_1
	const BATTLE_ANIM_FRAMESET_55 ; BATTLE_ANIM_FRAMESET_LEECH_SEED_2
	const BATTLE_ANIM_FRAMESET_56 ; BATTLE_ANIM_FRAMESET_LEECH_SEED_3
	const BATTLE_ANIM_FRAMESET_57 ; BATTLE_ANIM_FRAMESET_SOUND_1
	const BATTLE_ANIM_FRAMESET_58 ; BATTLE_ANIM_FRAMESET_SOUND_2
	const BATTLE_ANIM_FRAMESET_59 ; BATTLE_ANIM_FRAMESET_SOUND_3
	const BATTLE_ANIM_FRAMESET_5A ; BATTLE_ANIM_FRAMESET_WAVE
	const BATTLE_ANIM_FRAMESET_5B ; BATTLE_ANIM_FRAMESET_CONFUSE_RAY_1
	const BATTLE_ANIM_FRAMESET_5C ; BATTLE_ANIM_FRAMESET_CONFUSE_RAY_2
	const BATTLE_ANIM_FRAMESET_5D ; BATTLE_ANIM_FRAMESET_LEER
	const BATTLE_ANIM_FRAMESET_5E ; BATTLE_ANIM_FRAMESET_REFLECT
	const BATTLE_ANIM_FRAMESET_5F ; BATTLE_ANIM_FRAMESET_CHICK_1
	const BATTLE_ANIM_FRAMESET_60 ; BATTLE_ANIM_FRAMESET_CHICK_2
	const BATTLE_ANIM_FRAMESET_61 ; BATTLE_ANIM_FRAMESET_AMNESIA_1
	const BATTLE_ANIM_FRAMESET_62 ; BATTLE_ANIM_FRAMESET_AMNESIA_2
	const BATTLE_ANIM_FRAMESET_63 ; BATTLE_ANIM_FRAMESET_AMNESIA_3
	const BATTLE_ANIM_FRAMESET_64 ; BATTLE_ANIM_FRAMESET_ASLEEP
	const BATTLE_ANIM_FRAMESET_65 ; BATTLE_ANIM_FRAMESET_DIG_SAND
	const BATTLE_ANIM_FRAMESET_66 ; BATTLE_ANIM_FRAMESET_DIG_PILE
	const BATTLE_ANIM_FRAMESET_67 ; BATTLE_ANIM_FRAMESET_SAND
	const BATTLE_ANIM_FRAMESET_68 ; BATTLE_ANIM_FRAMESET_STRING_SHOT_1
	const BATTLE_ANIM_FRAMESET_69 ; BATTLE_ANIM_FRAMESET_STRING_SHOT_2
	const BATTLE_ANIM_FRAMESET_6A ; BATTLE_ANIM_FRAMESET_STRING_SHOT_3
	const BATTLE_ANIM_FRAMESET_6B ; BATTLE_ANIM_FRAMESET_PARALYZED
	const BATTLE_ANIM_FRAMESET_6C ; BATTLE_ANIM_FRAMESET_PARALYZED_FLIPPED
	const BATTLE_ANIM_FRAMESET_6D ; BATTLE_ANIM_FRAMESET_HAZE
	const BATTLE_ANIM_FRAMESET_6E ; BATTLE_ANIM_FRAMESET_MIST
	const BATTLE_ANIM_FRAMESET_6F ; BATTLE_ANIM_FRAMESET_HORN
	const BATTLE_ANIM_FRAMESET_70 ; BATTLE_ANIM_FRAMESET_NEEDLE
	const BATTLE_ANIM_FRAMESET_71 ; BATTLE_ANIM_FRAMESET_FLOWER
	const BATTLE_ANIM_FRAMESET_72 ; BATTLE_ANIM_FRAMESET_BARRAGE_BALL
	const BATTLE_ANIM_FRAMESET_73 ; BATTLE_ANIM_FRAMESET_PAY_DAY
	const BATTLE_ANIM_FRAMESET_74 ; BATTLE_ANIM_FRAMESET_HEART
	const BATTLE_ANIM_FRAMESET_75 ; BATTLE_ANIM_FRAMESET_SPINNING_BONE
	const BATTLE_ANIM_FRAMESET_76 ; BATTLE_ANIM_FRAMESET_STAR
	const BATTLE_ANIM_FRAMESET_77 ; BATTLE_ANIM_FRAMESET_SPOON
	const BATTLE_ANIM_FRAMESET_78 ; BATTLE_ANIM_FRAMESET_SPARKLE
	const BATTLE_ANIM_FRAMESET_79 ; BATTLE_ANIM_FRAMESET_SKY_ATTACK
	const BATTLE_ANIM_FRAMESET_7A ; BATTLE_ANIM_FRAMESET_LICK
	const BATTLE_ANIM_FRAMESET_7B ; BATTLE_ANIM_FRAMESET_WITHDRAW_SHELL
	const BATTLE_ANIM_FRAMESET_7C ; BATTLE_ANIM_FRAMESET_SHRINKING_CHARGE_ORB
	const BATTLE_ANIM_FRAMESET_7D ; BATTLE_ANIM_FRAMESET_CONVERSION
	const BATTLE_ANIM_FRAMESET_7E ; BATTLE_ANIM_FRAMESET_SWORD
	const BATTLE_ANIM_FRAMESET_7F ; BATTLE_ANIM_FRAMESET_SPEED_LINE_1
	const BATTLE_ANIM_FRAMESET_80 ; BATTLE_ANIM_FRAMESET_SPEED_LINE_2
	const BATTLE_ANIM_FRAMESET_81 ; BATTLE_ANIM_FRAMESET_SPEED_LINE_3
	const BATTLE_ANIM_FRAMESET_82 ; BATTLE_ANIM_FRAMESET_SEISMIC_TOSS
	const BATTLE_ANIM_FRAMESET_83 ; BATTLE_ANIM_FRAMESET_SHARPEN
	const BATTLE_ANIM_FRAMESET_84 ; BATTLE_ANIM_FRAMESET_DEFENSE_CURL
	const BATTLE_ANIM_FRAMESET_85 ; BATTLE_ANIM_FRAMESET_METRONOME_HAND
	const BATTLE_ANIM_FRAMESET_86 ; BATTLE_ANIM_FRAMESET_AGILITY
	const BATTLE_ANIM_FRAMESET_87 ; BATTLE_ANIM_FRAMESET_COTTON
	const BATTLE_ANIM_FRAMESET_88 ; BATTLE_ANIM_FRAMESET_MILK_BOTTLE
	const BATTLE_ANIM_FRAMESET_89 ; BATTLE_ANIM_FRAMESET_SPIKE
	const BATTLE_ANIM_FRAMESET_8A ; BATTLE_ANIM_FRAMESET_ANGER_VEIN
	const BATTLE_ANIM_FRAMESET_8B ; BATTLE_ANIM_FRAMESET_HEAL_BELL
	const BATTLE_ANIM_FRAMESET_8C ; BATTLE_ANIM_FRAMESET_BATON_PASS
	const BATTLE_ANIM_FRAMESET_8D ; BATTLE_ANIM_FRAMESET_LOCK_ON_1
	const BATTLE_ANIM_FRAMESET_8E ; BATTLE_ANIM_FRAMESET_LOCK_ON_2
	const BATTLE_ANIM_FRAMESET_8F ; BATTLE_ANIM_FRAMESET_LOCK_ON_3
	const BATTLE_ANIM_FRAMESET_90 ; BATTLE_ANIM_FRAMESET_LOCK_ON_4
	const BATTLE_ANIM_FRAMESET_91 ; BATTLE_ANIM_FRAMESET_MIND_READER_1
	const BATTLE_ANIM_FRAMESET_92 ; BATTLE_ANIM_FRAMESET_MIND_READER_2
	const BATTLE_ANIM_FRAMESET_93 ; BATTLE_ANIM_FRAMESET_MIND_READER_3
	const BATTLE_ANIM_FRAMESET_94 ; BATTLE_ANIM_FRAMESET_MIND_READER_4
	const BATTLE_ANIM_FRAMESET_95 ; BATTLE_ANIM_FRAMESET_SAFEGUARD
	const BATTLE_ANIM_FRAMESET_96 ; BATTLE_ANIM_FRAMESET_MEGAPHONE_UNUSED
	const BATTLE_ANIM_FRAMESET_97 ; BATTLE_ANIM_FRAMESET_ITEM_BAG
	const BATTLE_ANIM_FRAMESET_98 ; BATTLE_ANIM_FRAMESET_SPIDER_WEB
	const BATTLE_ANIM_FRAMESET_99 ; BATTLE_ANIM_FRAMESET_UNUSED_CAKE
	const BATTLE_ANIM_FRAMESET_9A ; BATTLE_ANIM_FRAMESET_IMP
	const BATTLE_ANIM_FRAMESET_9B ; BATTLE_ANIM_FRAMESET_IMP_FLIPPED
	const BATTLE_ANIM_FRAMESET_9C ; BATTLE_ANIM_FRAMESET_CHERUB
	const BATTLE_ANIM_FRAMESET_9D ; BATTLE_ANIM_FRAMESET_PENCIL
	const BATTLE_ANIM_FRAMESET_9E ; BATTLE_ANIM_FRAMESET_ENCORE_HAND
	const BATTLE_ANIM_FRAMESET_9F ; BATTLE_ANIM_FRAMESET_ENCORE_HAND_FLIPPED
	const BATTLE_ANIM_FRAMESET_A0 ; BATTLE_ANIM_FRAMESET_DESTINY_BOND
	const BATTLE_ANIM_FRAMESET_A1 ; BATTLE_ANIM_FRAMESET_MORNING_SUN
	const BATTLE_ANIM_FRAMESET_A2 ; BATTLE_ANIM_FRAMESET_GLIMMER
	const BATTLE_ANIM_FRAMESET_A3 ; BATTLE_ANIM_FRAMESET_MOONLIGHT
	const BATTLE_ANIM_FRAMESET_A4 ; BATTLE_ANIM_FRAMESET_CROSS_CHOP_1
	const BATTLE_ANIM_FRAMESET_A5 ; BATTLE_ANIM_FRAMESET_CROSS_CHOP_2
	const BATTLE_ANIM_FRAMESET_A6 ; BATTLE_ANIM_FRAMESET_ZAP_CANNON
	const BATTLE_ANIM_FRAMESET_A7 ; BATTLE_ANIM_FRAMESET_CURSE_NAIL
	const BATTLE_ANIM_FRAMESET_A8 ; BATTLE_ANIM_FRAMESET_FORESIGHT_SHINE
	const BATTLE_ANIM_FRAMESET_A9 ; BATTLE_ANIM_FRAMESET_RAPID_SPIN
	const BATTLE_ANIM_FRAMESET_AA ; BATTLE_ANIM_FRAMESET_SWAGGER
	const BATTLE_ANIM_FRAMESET_AB ; BATTLE_ANIM_FRAMESET_MEAN_LOOK
	const BATTLE_ANIM_FRAMESET_AC ; BATTLE_ANIM_FRAMESET_UPSIDE_DOWN_PUNCH
	const BATTLE_ANIM_FRAMESET_AD ; BATTLE_ANIM_FRAMESET_GROWING_SPARKLE
	const BATTLE_ANIM_FRAMESET_AE ; BATTLE_ANIM_FRAMESET_RAIN
	const BATTLE_ANIM_FRAMESET_AF ; BATTLE_ANIM_FRAMESET_PSYCH_UP
	const BATTLE_ANIM_FRAMESET_B0 ; BATTLE_ANIM_FRAMESET_SPIRAL_UNUSED
	const BATTLE_ANIM_FRAMESET_B1 ; BATTLE_ANIM_FRAMESET_AEROBLAST
	const BATTLE_ANIM_FRAMESET_B2 ; BATTLE_ANIM_FRAMESET_SANDSTORM
	const BATTLE_ANIM_FRAMESET_B3 ; BATTLE_ANIM_FRAMESET_ENEMYFEET_1ROW
	const BATTLE_ANIM_FRAMESET_B4 ; BATTLE_ANIM_FRAMESET_PLAYERHEAD_1ROW
	const BATTLE_ANIM_FRAMESET_B5 ; BATTLE_ANIM_FRAMESET_ENEMYFEET_2ROW
	const BATTLE_ANIM_FRAMESET_B6 ; BATTLE_ANIM_FRAMESET_PLAYERHEAD_2ROW
...
; AnimObjGFX indexes (see data/battle_anims/object_gfx.asm)
	...
	const BATTLE_ANIM_GFX_BIG_GLOW           ; 28
	const BATTLE_ANIM_GFX_BIG_GLOW_CLEAR     ; 29
	const BATTLE_ANIM_GFX_LEAF_STORM         ; 2a
	const BATTLE_ANIM_GFX_HURRICANE          ; 2b
	const BATTLE_ANIM_GFX_SWIRL              ; 2c
	const BATTLE_ANIM_GFX_OBJECTS_4          ; 2d
	const BATTLE_ANIM_GFX_VORTEX             ; 2e
	const BATTLE_ANIM_GFX_SMOKE_PUFF_BIG     ; 2f
