...
; Johto itemballs
	...
	const EVENT_UNION_CAVE_B2F_LEAF_STONE
	...
	const EVENT_OLIVINE_LIGHTHOUSE_5F_FIRE_STONE
	const EVENT_OLIVINE_LIGHTHOUSE_5F_TM_SWAGGER
	const EVENT_OLIVINE_LIGHTHOUSE_6F_THUNDERSTONE
	...
	const EVENT_ICE_PATH_B3F_TM_MANA_BURST
...
; New to Crystal
	...
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_MOON_STONE
