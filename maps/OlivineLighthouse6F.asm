...
OlivineLighthouse6F_MapEvents:
	...
	object_event  3,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, OlivineLighthouse6FThunderStone, EVENT_OLIVINE_LIGHTHOUSE_6F_THUNDERSTONE
