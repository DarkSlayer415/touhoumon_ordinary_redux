...
SilverCaveRoom2_MapEvents:
	...
	def_bg_events
	bg_event  8, 31, BGEVENT_ITEM, SilverCaveRoom2HiddenMaxPotion
	...
	object_event 14, 26, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2PPUp, EVENT_SILVER_CAVE_ROOM_2_PP_UP
